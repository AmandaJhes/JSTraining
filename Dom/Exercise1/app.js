...
console.log('01 - ', getCatInfo())
//console.log(`01 - ${getCatInfo().name} é um gato ${getCatInfo().color} de ${getCatInfo().age} anos.`)
...
const external = () => {
  ...
  const internal = () => {
    const extraInternal = () => {
      console.log("02 - ", movie.toUpperCase())
    }
...
console.log("03 - ", randomNumbers.reverse())
...
console.log("05 - ", dogs.find(p => p.name === 'Zequinha'))
